var reader = (function() {
  ...
  const adaptiveLayout = {
    ...
    render(article, container, options = {}, extras = {}) {
      ...
      const heroImage = profile.showHero ? article.images?.[0] : void 0;
      options.font;
      options.fontSize;
