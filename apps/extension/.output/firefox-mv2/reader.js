var reader=(function(){"use strict";function pn(r){return r}const Ot=["nav","aside","footer",'header:not(article header):not([class*="site-header"]):not([class*="main-header"])',".ad",".advertisement",".ads",".ad-container",".ad-slot",".ad-wrapper",".advert",'[id*="ad-"]','[class*="ad-"]','[id*="advert"]','[class*="advert"]',".sidebar",".related",".recommended",".suggestions",".more-stories",".social-share",".share-buttons",".social-links",".social-bar",".share-bar",".comments","#comments",".comment-section",".responses",".disqus","script","style","noscript",'iframe:not([src*="youtube"]):not([src*="vimeo"])','[class*="newsletter"]','[class*="subscribe"]','[class*="signup"]','[class*="popup"]','[class*="modal"]','[class*="lightbox"]',".author-bio",".author-info",".about-author",".post-author",".tags",".tag-list",".categories",".topic-tags",".breadcrumb",".breadcrumbs",".crumbs",".pagination",".pager",".page-nav",".cookie-notice",".gdpr",'[class*="consent"]','[class*="cookie-banner"]',".cookie-banner",'[class*="intercom"]','[class*="drift"]','[class*="zendesk"]','[class*="crisp"]','[class*="livechat"]','[class*="chat-widget"]',"#intercom-container",'[class*="paywall"]','[class*="premium"]','[class*="metered"]','[class*="locked"]','[class*="overlay"]','[class*="backdrop"]','[class*="mask"]','[class*="app-banner"]','[class*="install-prompt"]','[class*="download-app"]','[class*="survey"]','[class*="feedback"]','[class*="poll"]','[class*="rating"]','[class*="sponsored"]','[class*="promoted"]','[class*="native-ad"]','[class*="age-gate"]','[class*="age-verification"]','[class*="cookie-law"]','[class*="eu-cookie"]','[style*="position: sticky"]','[style*="position:fixed"]','[style*="display: none"]','[style*="display:none"]',"[hidden]",'[aria-hidden="true"]',".promo",".promo-banner",".promo-code",".newsletter-popup",".subscribe-popup","#wpadminbar",".amp-sidebar",".amp-menu"],Pt=["article h1",'h1[itemprop="headline"]','[property="og:title"]','meta[name="twitter:title"]',"h1.title",'h1[itemprop="name"]',".product-title",".product-name",".listing-title",".thread-title","h1",".post-title",".article-title",".entry-title",'[class*="title"] h1','meta[property="og:title"]'],$t=['[rel="author"]','[itemprop="author"]',".author-name",".byline",".author",'meta[name="author"]'],Lt=["time",'[itemprop="datePublished"]',"[datetime]",".post-date",".article-date",".publish-date",'meta[name="date"]','[property="article:published_time"]'],jt=["utm_source","utm_medium","utm_campaign","utm_term","utm_content","fbclid","gclid","gclsrc","mc_cid","mc_eid","ref","referer","referrer","affiliate","aff_id","campaign_id","ad_id","adgroup_id","ttclid","twclid","s_kwcid","scid","_ga","_gl","vero_id","mailchimp_campaign_id","fb_action_ids","fb_action_types","fb_source","fb_campaign_ids","oly_enc_id","oly_anon_id","perfmon_ref_id","spm","spm_id","rdt_cid","rdt_tid","trk_contact","trk_msg","trk_module","trk_sid","zanpid","igshid","tt_sigid","tt_mediaid"],Zt=["bit.ly","tinyurl.com","t.co","goo.gl","ow.ly","is.gd","buff.ly","adf.ly","j.mp","tr.im","tiny.cc","lnkd.in","db.tt","qr.ae","adcrun.ch","psty.jp","shorl.com","hypERM.com","firefe.st","cort.as","clck.ru","clicky.me","budurl.com","snipurl.com","snurl.com","short.to","url.ie","shorenstein.org"];function qe(r,e){try{const t=new URL(r,e),n=t.hostname;if(Zt.some(a=>n.includes(a)))return"";jt.forEach(a=>t.searchParams.delete(a)),t.searchParams.delete("_ga"),t.searchParams.delete("_gl"),t.searchParams.delete("ref"),t.searchParams.delete("ref_src"),t.searchParams.delete("ref_url"),t.hash="";const s=t.toString();return s===t.origin+t.pathname+"/"?"":s}catch{return""}}function zt(r,e,t="textOnly"){const n=qt(r),s=Wt(r),a=Vt(r),i=Dt(r),o=t!=="textOnly"?Jt(i):[],b=Kt(i,t,e),h=Qt(r),A=Xt(b.textContent||"");return{title:n,author:s,date:a,content:b.textContent||"",contentHtml:b,images:o,source:new URL(e).hostname,favicon:h,readingTime:A,url:e}}function qt(r){for(const e of Pt){const t=r.querySelector(e);if(t){const n=t.getAttribute("content")||t.textContent?.trim();if(n&&n.length>5&&n.length<300)return n}}return r.title||"Untitled"}function Wt(r){for(const e of $t){const t=r.querySelector(e);if(t){let n=t.getAttribute("content")||t.textContent?.trim();if(n&&n.length<100)return n=n.replace(/^(by|written by|reported by)\s+/i,""),n}}}function Vt(r){for(const e of Lt){const t=r.querySelector(e);if(t){const s=t.getAttribute("datetime")||t.getAttribute("content")||t.textContent?.trim();if(s)try{const a=new Date(s);if(!isNaN(a.getTime()))return a.toLocaleDateString("en-US",{year:"numeric",month:"long",day:"numeric"})}catch{continue}}}}function Dt(r){const e=r.querySelectorAll('main, article, [role="main"], [role="article"], section, div, body');let t=null,n=0;for(const s of Array.from(e)){if(!Ut(s))continue;const a=Ft(s);a>n&&(n=a,t=s)}return t||r.body}function Ut(r){const e=window.getComputedStyle(r);return!(e.display==="none"||e.visibility==="hidden"||e.opacity==="0"||parseFloat(e.opacity)<.1||r.hasAttribute("hidden")||r.getAttribute("aria-hidden")==="true"||r.hasAttribute("data-visible")&&r.getAttribute("data-visible")==="false")}function Ft(r){const e=r,t=e.textContent?.trim()||"",n=e.innerHTML||"";if(t.length<50)return 0;const s=t.length,a=n.length,i=a>0?s/a:0;if(i<.05)return 0;const o=e.querySelectorAll("p").length,b=e.querySelectorAll("h1,h2,h3,h4,h5,h6").length,h=e.querySelectorAll("ul, ol, dl").length,A=e.querySelectorAll("table").length,j=e.querySelectorAll("a").length,U=e.querySelectorAll("img").length,W=e.querySelectorAll("p, div, section, article, blockquote, pre, ul, ol, table").length;let d=0;d+=s*i,d+=o*100,d+=b*80,d+=h*60,d+=A*100,d+=j*5,d+=U*10,d+=W*30;const g=r.tagName.toLowerCase();g==="article"&&(d+=500),g==="main"&&(d+=400),g==="section"&&(d+=200);const u=Bt(r);return d*=Math.max(.3,1-u*.05),d>5e4?5e4:d}function Bt(r){let e=0,t=r.parentElement;for(;t;)e++,t=t.parentElement;return e}function Kt(r,e="textOnly",t=""){const n=r.cloneNode(!0);return Ot.forEach(s=>{n.querySelectorAll(s).forEach(a=>a.remove())}),e==="textOnly"?Gt(n):e==="safe"?Ht(n,t):e==="full"&&Yt(n,t),n}function Gt(r){r.querySelectorAll("figure").forEach(e=>{const t=e.querySelector("figcaption");if(t&&t.textContent?.trim()){const n=document.createElement("p");n.textContent=t.textContent.trim(),e.replaceWith(n)}else e.remove()}),r.querySelectorAll("img").forEach(e=>{const t=parseInt(e.getAttribute("width")||"0"),n=parseInt(e.getAttribute("height")||"0"),s=e.getAttribute("src")||"";t>0&&t<=32||n>0&&n<=32||s.startsWith("data:image/svg")||e.remove()}),r.querySelectorAll("video, audio, source, track, picture, canvas, embed, object, iframe").forEach(e=>e.remove()),r.querySelectorAll("*").forEach(e=>{const t=e;t.removeAttribute("style"),t.removeAttribute("class"),t.removeAttribute("id"),t.removeAttribute("onclick"),t.removeAttribute("onmouseover"),t.removeAttribute("onmouseout")}),r.querySelectorAll("a").forEach(e=>{const t=e.getAttribute("href");t&&!t.startsWith("http")&&!t.startsWith("/")&&!t.startsWith("#")&&e.removeAttribute("href"),e.setAttribute("target","_blank"),e.setAttribute("rel","noopener noreferrer")})}function Ht(r,e){r.querySelectorAll("figure").forEach(t=>{const n=t.querySelector("figcaption");if(n&&n.textContent?.trim()){const s=document.createElement("p");s.textContent=`[Image: ${n.textContent.trim()}]`,t.replaceWith(s)}else t.remove()}),r.querySelectorAll("img").forEach(t=>{const n=t.getAttribute("alt")||"Image",s=document.createElement("span");s.className="cw-media-placeholder",s.textContent=`[${n}]`,s.setAttribute("data-cw-media","image"),t.replaceWith(s)}),r.querySelectorAll("video, audio, source, track, picture, canvas, embed, object, iframe").forEach(t=>{const n=document.createElement("span");n.className="cw-media-placeholder",n.textContent=`[Media - ${t.tagName.toLowerCase()}]`,n.setAttribute("data-cw-media",t.tagName.toLowerCase()),t.replaceWith(n)}),r.querySelectorAll("a").forEach(t=>{const n=t.getAttribute("href")||"";if(n.startsWith("http")||n.startsWith("/")||n.startsWith("#")){const s=qe(n,e);s?t.setAttribute("href",s):t.removeAttribute("href"),t.setAttribute("target","_blank"),t.setAttribute("rel","noopener noreferrer")}else t.removeAttribute("href")}),r.querySelectorAll('button, input[type="submit"], input[type="button"], input[type="reset"]').forEach(t=>{t.setAttribute("data-cw-disabled","true"),t.setAttribute("disabled","true")}),r.querySelectorAll('input:not([type="submit"]):not([type="button"]):not([type="reset"]), textarea, select').forEach(t=>{t.setAttribute("data-cw-disabled","true"),t.setAttribute("disabled","true")}),r.querySelectorAll("*").forEach(t=>{const n=t;n.removeAttribute("onclick"),n.removeAttribute("onmouseover"),n.removeAttribute("onmouseout"),n.removeAttribute("onchange"),n.removeAttribute("onsubmit");const s=n.getAttribute("style")||"";s&&!s.includes("display")&&!s.includes("visibility")&&n.removeAttribute("style")})}function Yt(r,e){r.querySelectorAll("a").forEach(t=>{const n=t.getAttribute("href")||"";if(n.startsWith("http")||n.startsWith("/")||n.startsWith("#")){const s=qe(n,e);s?t.setAttribute("href",s):t.removeAttribute("href"),t.setAttribute("target","_blank"),t.setAttribute("rel","noopener noreferrer")}else t.removeAttribute("href")}),r.querySelectorAll("img").forEach(t=>{const n=t.getAttribute("src")||"";if(n.startsWith("javascript:")||n.startsWith("data:text/html"))t.remove();else{const s=qe(n,e);s&&t.setAttribute("src",s)}}),r.querySelectorAll("video, audio").forEach(t=>{t.removeAttribute("autoplay"),t.removeAttribute("autoplay"),t.querySelectorAll("source").forEach(s=>{(s.getAttribute("src")||"").startsWith("javascript:")&&s.remove()})}),r.querySelectorAll("iframe").forEach(t=>{const n=t.getAttribute("src")||"";(n.startsWith("javascript:")||!n.startsWith("http")&&!n.startsWith("/"))&&t.remove()}),r.querySelectorAll("form").forEach(t=>{t.setAttribute("data-cw-form-disabled","true"),t.addEventListener("submit",n=>n.preventDefault(),{once:!0})}),r.querySelectorAll("*").forEach(t=>{const n=t;n.removeAttribute("onclick"),n.removeAttribute("onmouseover"),n.removeAttribute("onmouseout"),n.removeAttribute("onchange"),n.removeAttribute("onsubmit"),n.removeAttribute("onfocus"),n.removeAttribute("onblur"),n.removeAttribute("onload"),n.removeAttribute("onerror");const s=n.getAttribute("style")||"";s&&(s.includes("expression")||s.includes("behavior")||s.includes("javascript:"))&&n.removeAttribute("style"),n.removeAttribute("id")})}function Jt(r){const e=[];return r.querySelectorAll("img").forEach(t=>{const n=t.getAttribute("src")||t.getAttribute("data-src");if(n&&!n.includes("avatar")&&!n.includes("icon")&&!n.includes("logo")){const s=t.getAttribute("alt")||"",i=t.closest("figure")?.querySelector("figcaption")?.textContent?.trim();e.push({src:n,alt:s,caption:i})}}),e.slice(0,20)}function Qt(r){const t=r.querySelector('link[rel="icon"], link[rel="shortcut icon"]')?.getAttribute("href");if(t)return t.startsWith("//")?"https:"+t:t.startsWith("/")?(r.location?.origin||"https://example.com")+t:t}function Xt(r){const t=r.split(/\s+/).length;return Math.max(1,Math.ceil(t/200))}function de(r){const e=document.createElement("span");return e.textContent=r,e.innerHTML}const at={id:"default",name:"Default",description:"Preserves original content structure",render(r,e,t={},n={}){const s=n.header||e.closest(".cw-overlay")?.querySelector(".cw-article-header"),a=n.footer||e.closest(".cw-overlay")?.querySelector(".cw-footer");s&&(s.innerHTML=`
...
- confidence should be lower for very messy/complex pages or pages with unusual structures`;let Ce=null,mt=null;function gt(){if(Ce)return Ce;try{mt=cr({appName:"CalmWeb"});const r=Ar("sync:auth");return Ce=sr({config:mt,getAuth:()=>r.getValue(),setAuth:e=>r.setValue(e),onAuthError:()=>{console.log("[CalmWeb] Auth error - user needs to log in")}}),Ce}catch(r){return console.error("[CalmWeb] Failed to initialize API client:",r),null}}async function vr(r){const e=gt();if(!e)return ft(r,"API client not available");try{const t=`Page URL: ${r.url}
Page Title: ${r.title}

Page Content:
${r.text}`,s=(await e.chatCompletions({messages:[{role:"system",content:xr},{role:"user",content:t}],stream:!1})).choices[0]?.message?.content||"";return wr(s,r.title)}catch(t){return console.error("[CalmWeb] API analysis failed:",t),ft(r,t.message||"Analysis failed")}}function wr(r,e){const t=r.trim();let n=t;const s=t.match(/```(?:json)?\s*\n?([\s\S]*?)\n?```/);s&&(n=s[1]);const a=n.match(/\{[\s\S]*\}/);if(a)try{const i=JSON.parse(a[0]);return{success:!0,title:i.title||e,summary:i.summary||"",filteredContent:i.filteredContent||"",confidence:i.confidence??.5,decisions:Array.isArray(i.decisions)?i.decisions:[],error:void 0}}catch{}return{success:!1,title:e,summary:"",filteredContent:t.slice(0,1e4),confidence:0,decisions:[],error:"Failed to parse AI response as JSON"}}function ft(r,e){return{success:!1,title:r.title,summary:"",filteredContent:r.text.slice(0,1e4),confidence:0,decisions:[],error:e}}async function _r(){const r=gt();if(!r)return{total:0,used:0,remaining:0,isPaidUser:!1};try{const[e,t]=await Promise.all([r.getUser(),r.getQuota()]),n=e.subscription?.active||!1,s=n?t.remaining:0;return{total:t.total,used:t.used,remaining:s,isPaidUser:n}}catch(e){return console.error("[CalmWeb] Failed to get quota:",e),{total:0,used:0,remaining:0,isPaidUser:!1}}}const De="calmweb-reader-host";async function Ee(r={}){document.body.style.setProperty("overflow","hidden","important"),me();const e=r.mode||"full";let t=null,n=null;const s=await _r();if(console.log("[CalmWeb] Quota check:",s.isPaidUser?"Paid user":"Free user","- Remaining:",s.remaining),s.isPaidUser&&s.remaining>0){console.log("[CalmWeb] Using AI-powered analysis...");try{n=await vr({title:document.title,url:window.location.href,html:document.body?.innerHTML?.slice(0,15e3)||"",text:document.body?.textContent?.slice(0,8e3)||""}),n.success?console.log("[CalmWeb] API analysis succeeded"):console.log("[CalmWeb] API analysis failed:",n.error)}catch(k){console.error("[CalmWeb] API analysis error:",k)}}else console.log("[CalmWeb] No AI - using CSS extraction (free tier)");if(!n?.success)try{t=zt(document,window.location.href,e)}catch(k){console.error("[CalmWeb] Extraction failed:",k)}const a=n?.title||t?.title||document.title||"Current Page",i=r.layoutId?er(r.layoutId):at,o=document.createElement("div");o.id=De,o.style.cssText=`
...
`;function fn(){const r=window.location.hostname.toLowerCase(),e=window.location.pathname.toLowerCase();return!!(["mail.google","calendar.google","drive.google","docs.google","sheets.google","slides.google","meet.google","github.com","gitlab.com","slack.com","discord.com","notion.so","figma.com","linear.app","trello.com","netflix.com","spotify.com","youtube.com"].some(a=>r.includes(a))||["/login","/signin","/signup","/register","/auth","/account","/settings","/admin","/dashboard","/checkout","/cart"].some(a=>e.startsWith(a))||document.querySelectorAll('input:not([type="hidden"]):not([type="search"]), textarea, select').length>4)}function Nt(){try{if(document.getElementById(Ze))return;document.body.style.setProperty("overflow","hidden","important");const r=document.createElement("div");r.id=Ze,r.innerHTML=`<style>${gn}</style>
      <div class="calmweb-loading-spinner"></div>
      <div class="calmweb-loading-text">Filtering...</div>`,document.body.appendChild(r)}catch(r){console.error("[CalmWeb] Loading screen failed:",r)}}function rt(){document.getElementById(Ze)?.remove()}function ve(){if(document.getElementById(tt))return;const r=document.createElement("div");r.id=tt,r.innerHTML='<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>',r.title="Filtered View (Ctrl+Shift+R)",Object.assign(r.style,{position:"fixed",bottom:"20px",right:"20px",width:"40px",height:"40px",borderRadius:"50%",background:"#8b5cf6",color:"white",display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer",zIndex:"2147483646",boxShadow:"0 4px 24px rgba(139, 92, 246, 0.3)",transition:"transform 0.15s ease",border:"none"}),r.addEventListener("mouseenter",()=>{r.style.transform="scale(1.1)"}),r.addEventListener("mouseleave",()=>{r.style.transform="scale(1)"}),r.addEventListener("click",()=>{r.remove(),Nt(),setTimeout(()=>{rt();try{Ee()}catch(e){console.error(e)}},300)}),document.body.appendChild(r)}function Mt(){document.getElementById(tt)?.remove()}function nt(){try{Ue()?(me(),ve()):(Mt(),Ee())}catch(r){console.error("[CalmWeb] Reader toggle failed:",r)}}const hn={matches:["<all_urls>"],runAt:"document_idle",async main(){console.log("[CalmWeb] Reader loaded on",window.location.hostname),document.addEventListener("keydown",t=>{t.ctrlKey&&t.shiftKey&&!t.altKey&&!t.metaKey&&t.key.toLowerCase()==="r"&&(t.preventDefault(),t.stopPropagation(),nt()),t.altKey&&!t.ctrlKey&&!t.metaKey&&!t.shiftKey&&t.key.toLowerCase()==="r"&&(t.preventDefault(),t.stopPropagation(),nt())},!0),mn.runtime.onMessage.addListener(t=>{if(t.type===H.TOGGLE_READER&&nt(),t.type===H.OPEN_READER){Mt();try{Ue()||Ee()}catch(n){console.error(n)}}if(t.type===H.CLOSE_READER)try{Ue()&&(me(),ve())}catch(n){console.error(n)}});let r=!0,e={};try{const t=cn({type:H.GET_SETTINGS}),n=new Promise((a,i)=>setTimeout(()=>i(new Error("Settings timeout")),2e3)),s=await Promise.race([t,n]);(s?.reader?.autoOpen===!1||s?.enabled===!1)&&(r=!1),e=s?.reader||{},console.log("[CalmWeb] Settings loaded, filtering:",r)}catch(t){console.warn("[CalmWeb] Settings load failed, defaulting to filter:",t)}if(!r){ve();return}if(fn()){ve();return}console.log("[CalmWeb] Opening reader..."),Nt(),Ee({mode:e.mode||"full",layoutId:e.defaultLayout,font:e.font,fontSize:e.fontSize}).then(()=>{rt(),console.log("[CalmWeb] Reader opened OK")}).catch(t=>{console.error("[CalmWeb] Reader failed:",t),rt(),ve()})}};function yn(){}function ze(r,...e){}const st={debug:(...r)=>ze(console.debug,...r),log:(...r)=>ze(console.log,...r),warn:(...r)=>ze(console.warn,...r),error:(...r)=>ze(console.error,...r)};return(()=>{try{}catch(e){throw st.error('Failed to initialize plugins for "reader"',e),e}let r;try{r=hn.main(),r instanceof Promise&&(r=r.catch(e=>{throw st.error('The unlisted script "reader" crashed on startup!',e),e}))}catch(e){throw st.error('The unlisted script "reader" crashed on startup!',e),e}return r})()})();
reader;